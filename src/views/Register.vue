                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <div class="text-center">
                                    <a class="small" href="#" @click="this.$router.push('/login')">Login</a>
                                </div>
  ...
  methods: {
    send_form () {
      if (this.check_form() === true) {
        ...
        Film.add_user(this.form).then(res => {
